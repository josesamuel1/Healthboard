...
export default function Classificacao() {
    ...
    const exportPlanilha = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/classificacao_de_risco/export/', {
                method: 'GET',
                headers: {
            ...
            if (response.ok) {
                ...
                link.href = url;
                link.setAttribute('download', 'Planilha_Classificacao_de_Risco.xlsx');
    ...
    const exportGrafico = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/classificacao_de_risco/grafico/export/', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
                    ...
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="w-full max-w-lg flex flex-col space-y-4 mb-4">
                            ...
                            <Button 
                                ...
                                onClick={() => router.push("/FormsClassif")}>
                                Criar Nova Planilha
                            </Button>
                        ...
                        <div className="flex justify-end">
                            <Image alt="imagem classificacao" src="/imagens/imagetelaclassificacao.svg" width={800} height={300} />
                        </div>
                    </div>
                </Card>
            </div>
