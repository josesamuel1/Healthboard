          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="w-1/2 flex flex-col justify-start">
              <h3 className="text-3xl font-bold text-white mb-6">
                Adicionar novo formulário em Clínica Médica
              </h3>
              <Image
                alt="imagem forms"
            ...
            <div className="w-1/2 flex flex-col items-start space-y-8">
              ...
              <div className="flex w-full space-x-4">
                <div className="w-1/3">
                  <label htmlFor="Fixos" className="text-white mb-2 block">Fixos</label>
                  <input 
                    type="number"
                    id="Fixos"
                ...
                <div className="w-1/3">
                  <label htmlFor="Bloqueados" className="text-white mb-2 block">Bloqueados</label>
                  <input 
                    type="number"
                    id="Bloqueados"
                    className="w-full h-12 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-green-800 bg-white/80"
                ...
                <div className="w-1/3">
                  <label htmlFor="extas" className="text-white mb-2 block">Extras</label>
                  <input 
                    type="number"
                    id="extras"
                    className="w-full h-12 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-green-800 bg-white/80"
              ...
              <div className="flex w-full space-x-4">
                ...
                Pacientes Entradas:
                  ...
                  <label htmlFor="Pelo Censo da meia noite" className="text-white mb-2 block">Pelo Censo da meia noite</label>
                  <input 
                    type="number"
                ...
                <div className="w-1/3">
                  <label htmlFor="Novas" className="text-white mb-2 block">Novas</label>
                  <input 
                    type="number"
                    id="Novas"
                    className="w-full h-12 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-green-800 bg-white/80"
                ...
                <div className="w-1/3">
                  <label htmlFor="Transf. Interna" className="text-white mb-2 block">Transf. Interna</label>
                  <input 
                    type="number"
                    id="Transf. Interna"
                    className="w-full h-12 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-green-800 bg-white/80"
