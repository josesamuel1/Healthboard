...
export default function Internacao() {
    ...
    const exportPlanilha = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/unidade_de_internacao/export/', {
                method: 'GET',
                headers: {
            ...
            if (response.ok) {
                ...
                link.href = url;
                link.setAttribute('download', 'Planilha_Unidade_de_Internacao.xlsx');
    ...
    const exportGrafico = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/unidade_de_internacao/grafico/export/', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
                        ...
                        <div className="flex items-center justify-between w-full">
                            ...
                            <div className="w-full max-w-lg flex flex-col space-y-4 mb-4">
                                ...
                                <Button
                                    ...
                                    onClick={() => router.push("/FormsInternacao")}
                                > 
                                    Criar Nova Planilha
                                </Button>
                                ...
                                <Button
                                    type="button"  // Corrigido para type="button" ao invés de "submit"
                                    className="w-full bg-white text-green-800 p-3 rounded-md hover:bg-green-700 hover:text-white transition duration-200"
